...
function themerex_ready_actions() {
    ...
    jQuery('.menu_main_wrap .menu_main_nav > li > ul').each(function() {
        jQuery(this).find('li.close').remove();
        var close = '<li class="close"></li>';
        jQuery(this).append(close);
    });

    jQuery('.menu_main_wrap .menu_main_nav > li > ul > li.close').click(function() {
        jQuery('.menu_main_wrap .menu_main_nav > li.open').removeClass('open');
    });


    //subsub menu
    jQuery('.menu_main_wrap .menu_main_nav > li > ul > li.menu-item-has-children > a').click(function(e) {
        jQuery('.menu_main_wrap .menu_main_nav > li > ul > li.open').removeClass('open');
    ...
    jQuery('.menu_main_wrap .menu_main_nav > li > ul > li > ul').each(function() {
        jQuery(this).find('li.back').remove();
        var back = '<li class="back"></li>';
        jQuery(this).append(back);
    });

    jQuery('.menu_main_wrap .menu_main_nav > li > ul > li > ul > li.back').click(function() {
        jQuery('.menu_main_wrap .menu_main_nav > li > ul > li.open').removeClass('open');
    });
    ...
    jQuery('.menu_user_login .popup_link').click(function() {
        jQuery(this).addClass('open');
        jQuery('.menu_user_register .popup_link').removeClass('open');
        jQuery('#popup_registration').hide();
        jQuery('#popup_login').show();
    });

    jQuery('.menu_user_register .popup_link ').click(function() {
        jQuery(this).addClass('open');
        jQuery('.menu_user_login .popup_link').removeClass('open');
        jQuery('#popup_registration').show();
        jQuery('#popup_login').hide();
    });

    jQuery('#popup_registration .popup_close, #popup_login .popup_close').click(function() {
        jQuery('.menu_user_login .popup_link, .menu_user_register .popup_link').removeClass('open');
    });

    jQuery('.menu_user_wrap .menu_user_right .menu_button').unbind("click").click(function(e) {
        ShowMenu(this);

        var windowHeight = jQuery(window).height();
        var x = jQuery('.menu_main_nav_area').height() + 122;
        /*
                if(windowHeight < x) jQuery('.menu_main_wrap').addClass('responsive');
                else jQuery('.menu_main_wrap').removeClass('responsive');*/
    ...
    jQuery(document).click(function(e) {
        ...
        if (jQuery('.menu_user_wrap .menu_user_right .menu_button').hasClass('hide_menu')) {
            if (jQuery(e.target).closest('.menu_main_wrap').length === 0) {
                var item = ('.menu_user_wrap .menu_user_right .menu_button');
                jQuery('.menu_main_wrap').css({
                    'display': 'none',
                    'z-index': '1'
                });
                jQuery('.page_wrap').removeClass('mask');
                jQuery(item).text('Show menu');
                jQuery(item).addClass('show_menu');
                jQuery(item).removeClass('hide_menu');
    ...
    jQuery('.menu_user_wrap .menu_user_right .menu_button').removeClass('hide_menu');

    //trx_section with margin-right < 0
    jQuery('.sc_section.minusRight').each(function() {
        var right = jQuery(this).css('margin-right');
        var maxWidth = 'calc(100% + ' + right + ')';
        jQuery(this).find(' > *').css('max-width', maxWidth);
    });

    //Footer
    jQuery('.footer_wrap .columns_wrap ').each(function() {
        var columns = jQuery(this).data('columns');
        if (columns) {
            var margins = columns * 40;
            var columnWidth = (jQuery(this).width() - margins) / columns - 54;
            jQuery(this).find('aside.widget').width(columnWidth);
        }
    });
...
function OpenMenu(parent) {
    ...
    var item = jQuery(parent).parent();
    jQuery(item).addClass('open');

    jQuery(document).click(function(e) {
        var target = e.target;
        if (!jQuery(target).is(item) && !jQuery(target).parents().is(item)) {
...
function ShowMenu(item) {
    if (!jQuery(item).hasClass('show_menu') && !jQuery(item).hasClass('hide_menu')) {
        jQuery(item).addClass('hide_menu');
    }
    if (jQuery(item).hasClass('show_menu')) {
        jQuery('.menu_main_wrap').css({
            'display': 'block',
            'z-index': '1002'
        });
        jQuery('.page_wrap').addClass('mask');
        jQuery(item).text('Hide menu');
        jQuery(item).addClass('hide_menu');
        jQuery(item).removeClass('show_menu');

        return false;
    } else if (jQuery(item).hasClass('hide_menu')) {
        jQuery('.menu_main_wrap').css({
            'display': 'none',
            'z-index': '1'
        });
...
function themerex_scroll_actions() {
    ...
    if (THEMEREX_GLOBALS['top_panel_height'] == 0) THEMEREX_GLOBALS['top_panel_height'] = jQuery('#wpadminbar').height();
    ...
    if (jQuery('body').hasClass('responsive_menu')) {
        ...
        } else if (scroll_offset > THEMEREX_GLOBALS['top_panel_height']) {
            if (!jQuery('body').hasClass('top_panel_fixed')) {
...
function themerex_resize_actions() {
    ...
    if (jQuery(window).width() > 480) {
        jQuery('.menu_main_wrap .menu_main_nav > li > a').hover(function(e) {
            OpenMenu(this);
        ...
        jQuery('.menu_main_wrap .menu_main_nav > li.menu-item-has-children > a').click(function(e) {
            OpenMenu(this);
    ...
    if (jQuery(window).width() > 1024) {
        //   jQuery('.menu_main_wrap').removeClass('responsive');

        var windowHeight = jQuery(window).height();
        var x = jQuery('.menu_main_nav_area').height() + 122;

        //       if(windowHeight < x) jQuery('.menu_main_wrap').addClass('absolute');
        //       else jQuery('.menu_main_wrap').removeClass('absolute');
        ...
        jQuery('.page_wrap').removeClass('mask');
        jQuery('.menu_user_wrap .menu_user_right .menu_button').text('Show menu');
        jQuery('.menu_user_wrap .menu_user_right .menu_button').removeClass('hide_menu');
        jQuery('.menu_user_wrap .menu_user_right .menu_button').addClass('show_menu');
    } else {
        //	jQuery('.menu_main_wrap').removeClass('absolute');
        ShowMenu('.menu_user_wrap .menu_user_right .menu_button');
    }
}
        ...
        jQuery('.sc_video_play_button:not(.inited)').each(function() {
            ...
            jQuery(this)
                ...
                .click(function(e) {
                    ...
                    if (jQuery(this).parents('.post_item_classic ').find('.post_content').length)
                        jQuery(this).parents('.post_item_classic ').find('.post_content').css('display', 'none');
                    e.preventDefault();
                    return false;
                });
        });
...
function themerex_comments_validate(form) {
    ...
    var error = themerex_form_validate(form, {
        ...
        rules: [{
            ...
            min_length: {
                value: 1,
                message: THEMEREX_GLOBALS['strings']['name_empty']
            },
            max_length: {
                value: 60,
                message: THEMEREX_GLOBALS['strings']['name_long']
            }
        }, {
            field: 'email',
            min_length: {
                value: 7,
                message: THEMEREX_GLOBALS['strings']['email_empty']
            },
            max_length: {
                value: 60,
                message: THEMEREX_GLOBALS['strings']['email_long']
            },
            mask: {
            ...
            min_length: {
                value: 1,
                message: THEMEREX_GLOBALS['strings']['text_empty']
            },
            max_length: {
...
function themerex_login_validate(form) {
    ...
    var error = themerex_form_validate(form, {
        ...
        rules: [{
            ...
            min_length: {
                value: 1,
                message: THEMEREX_GLOBALS['strings']['login_empty']
            },
            max_length: {
                value: 60,
                message: THEMEREX_GLOBALS['strings']['login_long']
            }
        }, {
            field: "pwd",
            min_length: {
                value: 4,
                message: THEMEREX_GLOBALS['strings']['password_empty']
            },
            max_length: {
                value: 30,
                message: THEMEREX_GLOBALS['strings']['password_long']
            }
        }]
    });
    if (!error) {
    ...
    var error = themerex_form_validate(form, {
        ...
        rules: [{
            ...
            equal_to: {
                ...
                message: THEMEREX_GLOBALS['strings']['password_not_equal']
            }
        }]
    });
    if (!error) {
    ...
    if (!form_custom) {
        error = themerex_form_validate(form, {
            ...
            rules: [{
                ...
                min_length: {
                    value: 1,
                    message: THEMEREX_GLOBALS['strings']['subject_empty']
                },
                max_length: {
                    value: 100,
                    message: THEMEREX_GLOBALS['strings']['subject_long']
                }
            }, {
                field: "message",
                min_length: {
